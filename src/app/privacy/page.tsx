...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for Draw Master GmbH — GDPR compliant.",
};
...
export default function PrivacyPage() {
  return (
    <div className="safe-px mx-auto max-w-3xl px-4 pt-28 pb-12 sm:px-6 sm:pt-32 sm:pb-16 md:pb-20">
      ...
      <p className="mt-2 text-sm text-neutral-400">Last updated: January 2024 · GDPR compliant</p>

      <div className="glass mt-10 space-y-8 p-6 text-sm leading-relaxed text-neutral-500 sm:p-8 sm:text-base">
        {[
          { title: "1. Data Controller", text: "Draw Master GmbH, Friedrichstraße 68, 10117 Berlin, Germany, is the data controller responsible for your personal data. Contact: privacy@drawmaster.de" },
          ...
          { title: "7. Contact", text: "For privacy enquiries, contact our Data Protection Officer at privacy@drawmaster.de or write to Draw Master GmbH, Friedrichstraße 68, 10117 Berlin, Germany." },
        ].map((s) => (
          <section key={s.title}>
