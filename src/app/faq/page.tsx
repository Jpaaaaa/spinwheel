...
export const metadata: Metadata = {
  title: "FAQ",
  description: "Frequently asked questions about Draw Master spin wheel raffles.",
};

const faqItems = [
  { question: "How does Draw Master ensure fairness?", answer: "Every spin uses JavaScript's cryptographically secure random number generator. Each winner is selected uniformly from remaining participants — no participant has an advantage over another." },
  ...
  { question: "What file formats are supported for upload?", answer: "Draw Master currently supports Excel files in .xlsx format. Names should be listed in the first column, one per row. A header row labelled 'Name' is automatically detected and skipped." },
  ...
  { question: "Can I use Draw Master for commercial events?", answer: "Absolutely. Draw Master is used by trade show organisers, marketing teams, and HR departments for commercial prize draws. The Pro plan includes custom branding for a professional presentation." },
  ...
  { question: "Can I display the spin wheel on a projector or live stream?", answer: "Yes. The spin page is fully responsive and looks great on large screens. Many customers run Draw Master on a laptop connected to a projector for live audience events." },
  ...
  return (
    <div className="safe-px mx-auto max-w-3xl px-4 pt-28 pb-12 sm:px-6 sm:pt-32 sm:pb-16 md:pb-20">
      <div className="text-center">
        ...
        <p className="section-subtitle mt-4">Everything you need to know about running fair raffles with Draw Master</p>
      </div>
